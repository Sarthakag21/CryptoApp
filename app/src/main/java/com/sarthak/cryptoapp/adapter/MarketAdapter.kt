package com.sarthak.cryptoapp.adapter
...
import com.sarthak.cryptoapp.databinding.CurrencyItemLayoutBinding
import com.sarthak.cryptoapp.fragment.HomeFragmentDirections
import com.sarthak.cryptoapp.fragment.MarketFragmentDirections
import com.sarthak.cryptoapp.fragment.WatchListFragment
import com.sarthak.cryptoapp.fragment.WatchListFragmentDirections
import com.sarthak.cryptoapp.models.CryptoCurrencyListItem

class MarketAdapter(var context: Context, var list: List<CryptoCurrencyListItem>, var type: String) : RecyclerView.Adapter<MarketAdapter.MarketViewHolder>() {
        ...
        holder.itemView.setOnClickListener{
            ...
            if(type=="home") {
                findNavController(it).navigate(
                    HomeFragmentDirections.actionHomeFragmentToDetailsFragment2(item)
                )
            }else if(type=="market"){
                findNavController(it).navigate(
                ...
                findNavController(it).navigate(
                    WatchListFragmentDirections.actionWishListFragmentToDetailsFragment4(item)
                )
            }
        }
    }
