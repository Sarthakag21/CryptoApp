...
import com.sarthak.cryptoapp.databinding.TopCurrencyLayoutBinding
import com.sarthak.cryptoapp.fragment.HomeFragmentDirections
import com.sarthak.cryptoapp.models.CryptoCurrencyListItem

class TopMarketAdapter(var context : Context, val list:List<CryptoCurrencyListItem>) : RecyclerView.Adapter<TopMarketAdapter.TopMarketViewHolder>() {
