...
import com.sarthak.cryptoapp.databinding.FragmentDetailsBinding
...
class DetailsFragment : Fragment() {
    ...
    private fun setButtonOnClick(item: CryptoCurrencyListItem) {
        ...
        val clickListener = View.OnClickListener {
            when(it.id){
                ...
                oneDay.id -> loadChartData(it, "D", item, oneDay, oneMonth, fifteenMinute, fourHour, oneHour)
                oneWeek.id -> loadChartData(it, "W", item, oneDay, fifteenMinute, oneWeek, fourHour, oneHour)
                oneMonth.id -> loadChartData(it, "M", item, fifteenMinute, oneMonth, oneWeek, fourHour, oneHour)
            }
        }
    ...
    private fun setUpDetailcs(data: CryptoCurrencyListItem) {
